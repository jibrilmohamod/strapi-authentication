   ...
   <div>
    <div class="relative">
     ...
     <div
      v-if="search"
      id="md-searchbar"
      class="bg-white w-full dark:bg-gray-900 lg:hidden py-5 px-6 items-center justify-between"
     >
       ...
       >
        <div class="hidden lg:flex items-center">
         ...
         <input
          ...
          type="text"
          placeholder="search"
          class="text-sm dark:bg-gray-900 dark:placeholder-gray-300 text-gray-600 rounded ml-1 border border-transparent focus:outline-none focus:border-gray-400 px-1"
         />
        </div>
       ...
       <ul class="flex flex-col space-y-6">
        <li>
         ...
         >
          ...
          <div>
           <svg
            class="fill-stroke text-black dark:text-white"
            width="12"
            height="12"
            viewBox="0 0 12 12"
            fill="none"
